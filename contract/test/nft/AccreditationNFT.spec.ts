...
describe(`Given ${CONTRACT_NAME}`, () => {
  it("Testing launchAccreditation error", () => {
    it("Should raise error if not using AccreditationEndpoint address", async () => {
  ...
  it("Testing isAccreditationExists error", () => {
    it("Should raise error if not using AccreditationEndpoint address", async () => {
      // TODO(Good to have): implement test
    });
  ...
  it("Testing launchAccreditation, isAccreditationExists", () => {
    it("Should issue Accreditation NFT correctly", async () => {
